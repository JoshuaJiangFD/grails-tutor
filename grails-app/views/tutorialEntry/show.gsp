...
<html>
    ...
    <body>
        <a href="#show-tutorialEntry" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="show-tutorialEntry" class="content scaffold-show" role="main">
